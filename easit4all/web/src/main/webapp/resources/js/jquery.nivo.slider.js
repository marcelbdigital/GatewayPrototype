...
(function($) {
    var NivoSlider = function(element, options){
        ...
        //Create Title
        slider.append($('<div class="nivo-title"></div>'));
        ...
        var processTitle = function(settings){
            ...
            if(vars.currentImage.attr('title') != '' && vars.currentImage.attr('title') != undefined){
                ...
                if(nivoTitle.css('display') == 'block'){
                    setTimeout(function(){
                        nivoTitle.html(title);
                    }, settings.animSpeed);
                } else {
                    nivoTitle.html(title);
                    nivoTitle.stop().fadeIn(settings.animSpeed);
                }
            } else {
                nivoTitle.stop().fadeOut(settings.animSpeed);
            }
        }
 
        //Process initial Title
